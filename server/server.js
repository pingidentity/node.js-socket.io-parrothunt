...
{                     
	...
	try{
	  ...
	  {
	      var strdata = ""+uuid.v1();
	      var cookies = "NODESESSIONID="+strdata+";"+"Expires=Thu, 26 Jun 2020 18:59:59 GMT";
	      res.setHeader('Set-Cookie', cookies);
	  }
	  else
	  {
	    if(req.headers.cookie.indexOf("NODESESSIONID") > -1)
	    {
	     var cookie = Cookie.parse(req.headers.cookie);
	     cookie.setExpires(tough.parseDate('Thu, 26 Jun 2020 18:59:59 GMT'));
